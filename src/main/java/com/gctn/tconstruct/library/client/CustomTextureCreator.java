package com.gctn.tconstruct.library.client;
...
import com.gctn.tconstruct.library.materials.MaterialGUI;
...
public class CustomTextureCreator /* implements IResourceManagerReloadListener */ {
    ...
    public void createCustomTextures(TextureStitchEvent.Pre event) {
        ...
        MaterialRenderInfoLoader.INSTANCE.onResourceManagerReload(Minecraft.getInstance().getResourceManager());
        ...
        if(exists(location)) {
            ...
            if(material.renderInfo.getTextureSuffix() != null) {
                ...
                if(base2 == null && exists(loc2)) {
                    base2 = TinkerTexture.loadManually(ResourceLocation.parse(loc2));
